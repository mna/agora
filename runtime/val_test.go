...
func TestAddMixed(t *testing.T) {
	cases := []struct {
		...
		// Float leads
		{x: Float(5), y: Float(3.24), exp: Float(8.24)},
		{x: Float(5), y: String("2"), exp: Float(7)},
		{x: Float(5), y: String("2.2"), exp: Float(7.2)},
		{x: Float(5), y: String("whatever"), exp: Nil, p: true},
		{x: Float(5), y: Bool(true), exp: Float(6)},
		{x: Float(5), y: Nil, exp: Nil, p: true},
		{x: Float(2.2), y: Float(3), exp: Float(5.2)},
		...
		// String leads
		{x: String("some"), y: Float(45), exp: String("some45")},
		{x: String("some"), y: Float(-5), exp: String("some-5")},
